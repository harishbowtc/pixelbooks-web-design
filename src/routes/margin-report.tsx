    ...
    <div className="p-4 md:p-8">
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card">
        ...
        <div className="grid gap-4 p-6 md:grid-cols-3">
          <div>
            <label className="mb-1.5 block text-sm font-medium text-foreground">Transaction Mode</label>
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-foreground">Transaction Date</label>
            <div className="flex h-14 w-full items-center rounded-xl border border-border bg-background px-4 text-sm text-muted-foreground">
              {detail.date}
            </div>
          </div>
          <div>
            <label className="mb-1.5 block text-sm font-medium text-foreground">Transaction Ref#</label>
            <div className="flex h-14 w-full items-center rounded-xl border border-border bg-background px-4 text-sm text-muted-foreground">
              {detail.ref}
            </div>
          </div>
              ...
              <tbody>
                {opening && (
                  <tr className="border-b border-border/60 bg-secondary/20 font-medium">
                    ...
                    <td className="py-4 pr-4 text-muted-foreground">{formatINR(opening.margin)}</td>
                ...
                {pageItems.length === 0 ? (
                  ...
                  pageItems.map((r) => {
                    ...
                    const isPayment = r.type === "Payment - Base Amount" && !!PAYMENT_DETAILS[r.ref];
                ...
                {closing && (
                  <tr className="bg-secondary/20 font-medium">
                    ...
                    <td className="py-4 pr-4 text-muted-foreground">{formatINR(closing.margin)}</td>
                    <td className="py-4 pr-4 text-muted-foreground">
