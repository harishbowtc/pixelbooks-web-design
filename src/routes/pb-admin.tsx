...
function PBAdminDashboard() {
  const [requests, setRequests] = useState<ApprovalRequest[]>([
    {
      ...
      date: "Today, 10:45 AM",
      details:
        "Requesting access to publish Higher Education catalogue (approx. 450 titles). Verified ISBN prefix.",
    },
    {
      id: "req-2",
      type: "promocode",
      ...
      date: "Today, 09:15 AM",
      details:
        "Promo code submission: Oxford Classics, 500 max redemptions, active till Dec 2026. Needs margin review.",
    },
    {
      id: "req-3",
      type: "library",
      ...
      details:
        "Onboarding campus library subscription tier (Academic Pro, 4500 active users, budget allocation ₹12,50,000).",
    },
    {
      id: "req-4",
      type: "publisher",
      ...
      details:
        "New publisher account onboarding. Corporate registration and GST verification completed.",
    },
  ]);
  ...
  const recentLogs = [
    {
      time: "10:52 AM",
      action: " oxford_press catalog import verified (412 titles)",
      user: "System Auto-Sync",
    },
    {
      time: "09:30 AM",
      action: "Updated licensing pricing model for Oxford Classics",
      user: "PB Admin (Self)",
    },
    {
      time: "08:15 AM",
      action: "Blocked IP 103.24.12.19 due to failed login threshold",
      user: "Security Watchdog",
    },
    {
      time: "Yesterday",
      action: "Approved payout of ₹4,82,900 to HarperCollins India",
      user: "PB Admin (Self)",
    },
  ];
        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((s) => {
            ...
            return (
              <div
                key={s.label}
                className="rounded-xl border border-border bg-card p-5 flex items-center justify-between shadow-sm"
              >
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Review and approve publisher profiles, institution requests, and special
                  promocodes.
                </p>
              </div>
            ...
            {requests.length === 0 ? (
              <div className="rounded-xl border border-dashed border-border bg-card/40 p-12 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  All onboarding and code requests have been processed.
                </p>
              </div>
            ) : (
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">
                          Submitted by {req.submittedBy} · {req.date}
                        </p>
                      </div>
            ...
            <section className="rounded-xl border border-border bg-card p-5 space-y-4 shadow-sm">
              <div>
                ...
                <p className="text-[11px] text-muted-foreground">
                  Live records of system action histories.
                </p>
              </div>
