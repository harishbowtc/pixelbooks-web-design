      ...
      <div className="flex-1 flex flex-col min-h-0 bg-background">
        ...
        <div className="flex items-center gap-2 border-b border-border bg-secondary/30 px-6 py-3">
          <Link
            ...
            className="flex items-center text-sm font-semibold text-foreground hover:text-brand transition-colors"
          >
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-6xl mx-auto rounded-xl border border-border bg-card p-6 md:p-8 shadow-sm">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-5">
                    <div>
                      <label className="mb-1.5 block text-xs font-semibold text-muted-foreground">Author Name</label>
                      <input
                        readOnly
                    ...
                    <div>
                      <label className="mb-1.5 block text-xs font-semibold text-muted-foreground">PAN Card</label>
                      <input
                        readOnly
                    ...
                    <div>
                      <label className="mb-1.5 block text-xs font-semibold text-muted-foreground">Address Line 2</label>
                      <input
                        readOnly
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <label className="mb-1.5 block text-xs font-semibold text-muted-foreground">Address Line 1</label>
                      <input
                        readOnly
                    ...
                    <div>
                      <label className="mb-1.5 block text-xs font-semibold text-muted-foreground">Pincode</label>
                      <input
                        readOnly
                ...
                <div>
                  <h3 className="mb-4 mt-8 text-sm font-bold text-foreground">Add Commission Details</h3>
                  <div className="space-y-5">
                    <div>
